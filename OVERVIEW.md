...
- **Phase 1–3 done:** full accounting cycle (manual/UI) + local Ollama agent (tools = service, permission inheritance) + RAG (company policies) + vision invoice parsing. **332 tests · 58 AI tools.**
