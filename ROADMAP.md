...
| — | 📧이메일 커넥터(Gmail OAuth) · 선택 롤(people/docs/support) · 분류기 확장 | 후속 |
| ✅ | 📦supply 롤(패킹리스트→입고 드래프트) · 채팅 P2P 완결(업체온보딩·링크요청·PO발행·PO입고·진짜 3-way) · plan-then-execute · 대화 간 메모리 · **거버넌스 학습 루프**(벤더 별칭 마이닝, ADR-10) | 2026-07-24 |
