...
class Conversation(PKMixin, Base):
    ...
    # Rolling summary of turns that have scrolled out of the live window (memory
    # scaling for long chats), plus the highest message id already folded into it.
    summary: Mapped[str | None] = mapped_column(Text, nullable=True)
    summarized_upto_id: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
